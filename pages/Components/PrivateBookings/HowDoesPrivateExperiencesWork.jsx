            ...
            <Container variant="ct110" maxWidth="xl">
                <Grid container spacing={15}>
                    ...
                    <Grid item sm={6} sx={{fontFamily: "Gordita-Regular"}}>
                        ...
                        <Box sx={{ mt: "32px" }}>
                            <Typography variant="fs16fw700" fontFamily="Gordita"> Step 1 </Typography> <br />
                        ...
                        <Box sx={{ mt: "22px" }}>
                            <Typography variant="fs16fw700" fontFamily="Gordita"> Step 2 </Typography> <br />
                            <Typography variant="fs16fw700" fontWeight="400"> Find the experience that you like. </Typography>
                        </Box>

                        <Box sx={{ mt: "22px" }}>
                            <Typography variant="fs16fw700" fontFamily="Gordita"> Step 3 </Typography> <br />
                            <Typography variant="fs16fw700" fontWeight="400"> Click on Inquire Now. </Typography>
                        </Box>

                        <Box sx={{ mt: "22px" }}>
                            <Typography variant="fs16fw700" fontFamily="Gordita"> Step 4 </Typography> <br />
                            <Typography variant="fs16fw700" fontWeight="400"> Complete our Private Booking Form. </Typography>
                        </Box>

                        <Box sx={{ mt: "22px" }}>
                            <Typography variant="fs16fw700" fontFamily="Gordita"> Step 5 </Typography> <br />
