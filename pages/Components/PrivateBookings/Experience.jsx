...
import { Box, Container, Collapse, Grid, Typography, ButtonBase } from '@mui/material'

import OnSale from "../IndexPage/OnSale"
import KeyboardArrowDownIcon from '@mui/icons-material/KeyboardArrowDown';
import styles from "../../upcoming-experiences/index.module.css"
...
function Experience() {
  ...
  return (
    <div>
        <Container variant="ct110" sx={{ pt: "82px" }} maxWidth="xl">
                <Grid container>
                <Grid item sm={12}>
                        <Typography variant="fs26fw700"> Experiences Available For Private Booking </Typography>
                        </Grid>
                    <Grid item sm={3}>
                        
                        <Box sx={{ pt: "74px", maxWidth: "190px", display: "flex", flexDirection: "column" }}>
                    ...
                    <Grid container spacing={5} item  sm={9}>
                        ...
                        <Grid item xs={4}>
                            <OnSale sOnline minimum sale="on sale" image="/Images/Paintings/p1.png" absoluteText="printmaking" title="Linocut Print Workshop with Henry the Rabbit" price="500 DKK" place="Copenhagen, Denmark" dateString="Tuesday, 19th Jul 2022, 22:00 - 00:30" hosted="Hosted by Craig Martin Wood" />
                        </Grid>
                        ...
                        <Grid item sm={12} sx={{ mt: "60px", display: "flex", justifyContent: "center" }}>
